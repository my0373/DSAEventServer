...
#### Expected output
```
INFO     Using path src/swimming.py                                             
INFO     Resolved absolute path /code/src/swimming.py                           
...
INFO     Importing module swimming                                              
...
INFO     Using import string swimming:app                                       
...
Open a web browser to [http://127.0.0.1:8080/swimmer](http://127.0.0.1:8080/swimmer)
